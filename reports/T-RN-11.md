...
- Issue #11 remains open pending independent exact-SHA review and merge; Draft PR #14 is linked without an auto-close directive.
- PR head: verified after publication against local and origin.
